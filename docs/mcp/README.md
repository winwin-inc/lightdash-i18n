...
| [**MCP v2 Keycloak OAuth 鉴权**](./lightdash-mcp-v2-keycloak-oauth.md) | **v2 Keycloak + 邮箱换票**（一人一票、TTL、失效续期、Keycloak 前提） |
...
**v2 要点**：MCP 2026-07-28 [Streamable HTTP](https://modelcontextprotocol.io/specification/2026-07-28/basic/transports/streamable-http)；sessionless + legacy:stateless；无 set_project；项目用 projectUuid 或 LIGHTDASH_PROJECT_UUID；**鉴权为 Keycloak OAuth + 邮箱换票短期 PAT**（见 [Keycloak 专题](./lightdash-mcp-v2-keycloak-oauth.md)）；打 mcp-v* tag 构建 @lightdash/mcp-v2 镜像。
