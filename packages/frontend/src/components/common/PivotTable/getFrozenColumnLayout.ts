...
/** Optional width used for sticky offset calc; not required on saved ColumnProperties */
type ColumnPropertiesForFreeze = ColumnProperties & {
    width?: number;
};

type Args = {
    pivotColumnInfo: PivotColumn[];
    columnProperties: Record<string, ColumnPropertiesForFreeze | undefined>;
