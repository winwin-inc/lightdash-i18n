    ...
    >({
        ...
        onSuccess: async (job, { fixAll, from, type, resourceUrl }) => {
            showToastSuccess({
                ...
                title: t(
                    'components_settings_validator_hooks.rename_chart_toast.success',
                    {
                        type,
                        from,
                    },
                ...
                action: {
                    children: t(
                        'components_settings_validator_hooks.rename_chart_toast.open',
                    ),
                    icon: IconArrowRight,
                    onClick: () => {
            ...
            if (fixAll && job?.jobId) {
                showToastInfo({
                    ...
                    title: t(
                        'components_settings_validator_hooks.rename_references_toast.updating',
                        {
                            type,
                            from,
                        },
                ...
                pollJobStatus(job.jobId)
                    .then((status) => {
                        ...
                        showToastSuccess({
                            key: 'rename_references_toast',
                            title: t(
                                'components_settings_validator_hooks.rename_references_toast.success',
                                {
                                    type,
                                    from,
                                    totalCharts,
                    ...
                    .catch((e) => {
                        ...
                        showToastError({
                            key: 'rename_references_toast',
                            title: t(
                                'components_settings_validator_hooks.rename_references_toast.error',
                                {
                                    type,
                                },
                            ),
        ...
        onError: (error) => {
            ...
            showToastError({
                key: 'rename_chart_toast',
                title: t(
                    'components_settings_validator_hooks.rename_references_toast.failed',
                ),
