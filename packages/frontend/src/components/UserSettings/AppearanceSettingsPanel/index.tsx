...
const useDefaulColorPalettes = () => {
    const { t } = useTranslation();

    return [
        {
            name: t(
                'components_user_settings_appearance_settings_panel.color_palettes.default_colors',
            ),
        ...
        {
            name: t(
                'components_user_settings_appearance_settings_panel.color_palettes.lightdash_of_colors',
            ),
            icon: IconBolt,
            colors: [
                '#7162FF',
        ...
        {
            name: t(
                'components_user_settings_appearance_settings_panel.color_palettes.sunrise_erenity',
            ),
            icon: IconSunglasses,
            colors: [
                '#FF6464',
        ...
        {
            name: t(
                'components_user_settings_appearance_settings_panel.color_palettes.autumn_sunset',
            ),
            icon: IconLeaf,
            colors: [
                '#C2590F',
        ...
        {
            name: t(
                'components_user_settings_appearance_settings_panel.color_palettes.oceanic_bules',
            ),
            icon: IconRipple,
            colors: [
                '#0D4F8B',
        ...
        {
            name: t(
                'components_user_settings_appearance_settings_panel.color_palettes.data_matrix',
            ),
...
const findMatchingDefaultColorPalette = (
    ...
    colorPalettes.find((palette) => isEqual(palette.colors, colors));
    ...
    return (
        <Flex align="center" justify="space-between" gap="xl">
            ...
            <Button size="xs" ml="xs" onClick={onSelect} disabled={isActive}>
                {t(
                    'components_user_settings_appearance_settings_panel.use_theme',
                )}
            </Button>
        </Flex>
    );
...
const AppearanceColorSettings: FC = () => {
    ...
    const defaultColorPalettes = useDefaulColorPalettes();
    const { t } = useTranslation();
            ...
            (acc, key) => ({
                [key]: (value: string) =>
                    !isHexCodeColor(value)
                        ? t(
                              'components_user_settings_appearance_settings_panel.validate.hex',
                          )
                        : null,
                ...acc,
            }),
    ...
    const activeColorPalette =
        ...
        findMatchingDefaultColorPalette(
    ...
    const renderColorInputLabel = useCallback(
            ...
            return (
                <Group mb="xxs">
                    <Text size={'xs'} color="gray">
                        {t(
                            'components_user_settings_appearance_settings_panel.color',
                            {
                                index: colorIndex + 1,
                            },
                        )}
                    ...
                    {differsFromDefault && (
                        <Tooltip
                            label={t(
                                'components_user_settings_appearance_settings_panel.restore_default_color',
                            )}
                        >
                            <ActionIcon
                                size="xs"
        ...
        [form, activeColorPaletteOrDefault, t],
    );
        ...
        <Stack spacing="md">
            <Flex justify="space-between">
                <Stack spacing="xs">
                    <Title order={5}>
                        {t(
                            'components_user_settings_appearance_settings_panel.default_chart_colors',
                        )}
                    </Title>
                    <Text c="gray.6" fz="xs">
                        {t(
                            'components_user_settings_appearance_settings_panel.start',
                        )}
                    </Text>
                </Stack>
                <Popover position="bottom-end">
                    <Popover.Target>
                        ...
                        >
                            {t(
                                'components_user_settings_appearance_settings_panel.color_themes',
                            )}
                        </Button>
                    </Popover.Target>
                    <Popover.Dropdown>
                    ...
                    >
                        <Flex justify="flex-end" gap="sm">
                            {form.isDirty() && (
                                ...
                                >
                                    {t(
                                        'components_user_settings_appearance_settings_panel.cancel',
                                    )}
                                </Button>
                            )}
                            <Button
                            ...
                            >
                                {t(
                                    'components_user_settings_appearance_settings_panel.save',
                                )}
                            </Button>
                        </Flex>
                    </Can>
