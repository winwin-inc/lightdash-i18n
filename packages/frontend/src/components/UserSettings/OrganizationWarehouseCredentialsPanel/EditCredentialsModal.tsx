    ...
    return (
        <Modal
            ...
            title={
                <Title order={4}>
                    {t(
                        'components_user_settings_organization_warehouse_credentials_panel.edit_credentials.edit_credentials',
                    )}
                </Title>
            }
            opened={opened}
        ...
        >
            ...
            >
                ...
                <Group position="right" spacing="xs" mt="sm">
                    ...
                    >
                        {t(
                            'components_user_settings_organization_warehouse_credentials_panel.edit_credentials.cancel',
                        )}
                    </Button>
                    ...
                    >
                        {t(
                            'components_user_settings_organization_warehouse_credentials_panel.edit_credentials.save',
                        )}
                    </Button>
                </Group>
            </form>
