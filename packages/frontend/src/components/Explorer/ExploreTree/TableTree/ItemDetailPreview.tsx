                        ...
                        <Group spacing="xs" align="center" position="apart">
                            ...
                            <Tooltip
                                ...
                                label={
                                    showCompiled
                                        ? t(
                                              'components_explorer_tree.sql.show_original',
                                          )
                                        : t(
                                              'components_explorer_tree.sql.show_compiled',
                                          )
                                }
                            >
                                <Button
                                ...
                                >
                                    {showCompiled
                                        ? t(
                                              'components_explorer_tree.sql.original',
                                          )
                                        : t(
                                              'components_explorer_tree.sql.compiled',
                                          )}
                                </Button>
                            </Tooltip>
                        </Group>
                                                    ...
                                                    {isDateFilterRule(
                                                        ...
                                                        <Fragment>
                                                            ...
                                                            {filter.settings
                                                                ?.completed
                                                                ? t(
                                                                      'components_explorer_tree.completed',
                                                                  )
                                                                : ''}
                                                            {
                                                                filter.settings
