...
const VisualizationWarning: FC<PivotMismatchWarningProps> = ({
    ...
    const messages = useMemo(() => {
        ...
        if (shouldShowUnusedDims) {
            _messages.push(
                t(
                    'components_explorer_visualization_card_warning.waiting.part_1',
                ),
            );
        }
        if (shouldShowPivotMismatch) {
            _messages.push(
                t(
                    'components_explorer_visualization_card_warning.waiting.part_2',
                ),
            );
        }
        return _messages;
    ...
    return (
        ...
        >
            ...
            >
                {t(
                    'components_explorer_visualization_card_warning.results_may_be_incorrect',
                )}
            </Badge>
        </Tooltip>
    );
