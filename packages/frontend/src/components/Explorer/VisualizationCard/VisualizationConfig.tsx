    ...
    return (
        <>
            <Group position="apart">
                <Text fz={16} fw={600}>
                    {t("components_explorer_visualization_config.configure_chart")}
                </Text>

                <Tooltip label={t("components_explorer_visualization_config.close_visualization_config")}>
            ...
            <Group>
                <Text fw={600}>{t("components_explorer_visualization_config.chart_type")}</Text>
