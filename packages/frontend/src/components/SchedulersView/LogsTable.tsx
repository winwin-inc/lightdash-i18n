...
const LogsTable: FC<LogsTableProps> = ({ projectUuid }) => {
    ...
    const columns: MRT_ColumnDef<TableRow>[] = useMemo(
        () => [
            {
                ...
                header: t('components_schedulers_view_logs_table.name.label'),
                enableSorting: false,
                size: 250,
                Header: ({ column }) => (
                    <Group gap="two">
            ...
            {
                accessorKey: 'logs',
                header: t('components_schedulers_view_logs_table.job.label'),
                enableSorting: false,
                size: 140,
                Cell: ({ row }) => {
                    const rowData = row.original;
                    ...
                    if (isLogGroup(rowData)) {
                        ...
                        return (
                            <Text fz="xs" fw={500} c="gray.7">
                                {t(
                                    'components_schedulers_view_logs_table.job.groups.all_jobs',
                                )}
                            </Text>
                        );
                    } else {
            ...
            },
            {
                ...
                header: t(
                    'components_schedulers_view_logs_table.scheduled.label',
                ),
                enableSorting: false,
                size: 140,
                Header: ({ column }) => (
            ...
            },
            {
                ...
                header: t(
                    'components_schedulers_view_logs_table.started.label',
                ),
                enableSorting: false,
                size: 140,
                Header: ({ column }) => (
            ...
            {
                accessorKey: 'status',
                header: t('components_schedulers_view_logs_table.status.label'),
                enableSorting: false,
                size: 90,
                Cell: ({ row }) => {
                    const rowData = row.original;
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <Menu.Dropdown maw={280}>
                                                ...
                                                >
                                                    {t(
                                                        'components_schedulers_view_logs_table.status.groups.send_now',
                                                    )}
                                                </Menu.Item>
                                            </Menu.Dropdown>
                                        </Menu>
        ...
        [schedulerLogsData, projectUuid, theme, t],
    );
