...
const SchedulersTable: FC<SchedulersTableProps> = ({ projectUuid }) => {
    ...
    const columns: MRT_ColumnDef<SchedulerItem>[] = useMemo(
        () => [
            {
                accessorKey: 'name',
                header: t('components_schedulers_view_table.name.label'),
                enableSorting: true,
                size: 300,
                Header: ({ column }) => (
                    <Group gap="two">
            ...
            },
            {
                ...
                header: t('components_schedulers_view_table.frequency.label'),
                enableSorting: false,
                size: 150,
                Header: ({ column }) => (
                    <Group gap="two">
...

            {
                ...
                header: t('components_schedulers_view_table.created.label'),
                enableSorting: true,
                size: 130,
                Header: ({ column }) => (
                    <Group gap="two" wrap="nowrap">
        ...
        [project, projectUuid, getSlackChannelName, t],
    );
