...
export const VisualizationSwitcher = ({
    ...
    const AVAILABLE_VISUALIZATIONS = [
        {
            label: t('features_sql_runner_visualization_switcher.table'),
            value: ChartKind.TABLE,
        },
        {
            label: t('features_sql_runner_visualization_switcher.bar_chart'),
            value: ChartKind.VERTICAL_BAR,
        },
        {
            label: t('features_sql_runner_visualization_switcher.line_chart'),
            value: ChartKind.LINE,
        },
        {
            label: t('features_sql_runner_visualization_switcher.pie_chart'),
            value: ChartKind.PIE,
        },
    ];
