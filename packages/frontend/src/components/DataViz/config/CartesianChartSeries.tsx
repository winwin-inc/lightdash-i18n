            ...
            {series.length > 0 && (
                <Config>
                    <Config.Group>
                        <Config.Label>
                            {t(
                                'components_dataviz_config_cartesian_chart.stacking',
                            )}
                        </Config.Label>
                        <SegmentedControl
                            radius="md"
                            ...
                            data={[
                                {
                                    value: 'None',
                                    label: t(
                                        'components_dataviz_config_cartesian_chart.none',
                                    ),
                                },
                                {
                                    value: 'Stacked',
                                    label: t(
                                        'components_dataviz_config_cartesian_chart.stacked',
                                    ),
                                },
                            ]}
                            defaultValue={
                    ...
                    <Stack key={reference} spacing="xs">
                        ...
                        >
                            ...
                            <Config.Group>
                                <Config.Label>
                                    {t(
                                        'components_dataviz_config_cartesian_chart.label',
                                    )}
                                </Config.Label>
                            ...
                            <Config.Group>
                                <Config.Label>
                                    {t(
                                        'components_dataviz_config_cartesian_chart.chart_type',
                                    )}
                                </Config.Label>
                            ...
                            <Config.Group>
                                <Config.Label>
                                    {t(
                                        'components_dataviz_config_cartesian_chart.y_axis',
                                    )}
                                </Config.Label>
                                <SegmentedControl
                                    sx={{ alignSelf: 'center' }}
                                    ...
                                    data={[
                                        {
                                            ...
                                            label: (
                                                <Group spacing="xs" noWrap>
                                                    ...
                                                    <Text>
                                                        {t(
                                                            'components_dataviz_config_cartesian_chart.left',
                                                        )}
                                                    </Text>
                                                </Group>
                                            ),
                                        },
                                        {
                                            ...
                                            label: (
                                                <Group spacing="xs" noWrap>
                                                    <Text>
                                                        {t(
                                                            'components_dataviz_config_cartesian_chart.right',
                                                        )}
                                                    </Text>
                                                    <MantineIcon
                                                        icon={IconAlignRight}
                            ...
                            <Config.Group>
                                <Config.Label>
                                    {t(
                                        'components_dataviz_config_cartesian_chart.values_labels',
                                    )}
                                </Config.Label>
