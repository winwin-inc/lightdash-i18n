        ...
        >
            <Group spacing="sm" position="apart" noWrap>
                ...
                {(item.type === ProjectType.PREVIEW || isActive) && (
                    ...
                    >
                        {isActive
                            ? t('components_navbar_project_switcher.active')
            ...
            >
                ...
                <Menu.Dropdown maw={400}>
                    ...
                    >
                        <TextInput
                            placeholder={t(
                                'components_navbar_project_switcher.search_projects',
                            )}
                            value={searchQuery}
                            onChange={(e) =>
                    ...
                    <Stack spacing={0}>
                        ...
                        {baseProjects.length > 0 && (
                            <Box>
                                <GroupHeader
                                    title={t(
                                        'components_navbar_project_switcher.projects',
                                    )}
                                ...
                                <Box p="lg" ta="center">
                                    <Stack spacing="xs" align="center">
                                        ...
                                        <Text {...MENU_TEXT_PROPS}>
                                            {debouncedSearchQuery.length >= 2
                                                ? t(
                                                      'components_navbar_project_switcher.no_projects_found',
                                                      {
                                                          searchQuery:
                                                              debouncedSearchQuery,
                                                      },
                                                ...
                                                : t(
                                                      'components_navbar_project_switcher.no_projects_available',
                                                  )}
                                        </Text>
                                    </Stack>
                                </Box>
