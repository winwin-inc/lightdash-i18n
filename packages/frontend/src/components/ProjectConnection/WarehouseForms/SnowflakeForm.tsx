        ...
        <>
            <Stack style={{ marginTop: '8px' }}>
                ...
                {useOrgCredentials && snowflakeOrgCredentials.length > 0 && (
                    <Select
                        label={t(
                            'components_project_connection_warehouse_form.snowflake.organization_credentials.label',
                        )}
                        description={t(
                            'components_project_connection_warehouse_form.snowflake.organization_credentials.description',
                        )}
                        placeholder={t(
                            'components_project_connection_warehouse_form.snowflake.organization_credentials.placeholder',
                        )}
                    ...
                    <>
                        ...
                        <Group spacing="sm">
                            <Select
                                ...
                                label={t(
                                    'components_project_connection_warehouse_form.snowflake.authentication_type.label',
                                )}
                                description={
                                    isSsoEnabled &&
                        ...
                        SnowflakeAuthenticationType.PRIVATE_KEY ? (
                            <>
                                <FileInput
                                    ...
                                    label={t(
                                        'components_project_connection_warehouse_form.snowflake.private_key_file.label',
                                    )}
                                    ...
                                    placeholder={
                                        !requireSecrets
                                            ? '**************'
                                            : t(
                                                  'components_project_connection_warehouse_form.snowflake.private_key_file.placeholder',
                                              )
                                    }
                                    description={
                                        <p>
                                            {t(
                                                'components_project_connection_warehouse_form.snowflake.private_key_file.description.part_1',
                                            )}{' '}
                                            <Anchor
                                                target="_blank"
                                            ...
                                            >
                                                {t(
                                                    'components_project_connection_warehouse_form.snowflake.private_key_file.description.part_2',
                                                )}
                                            </Anchor>
                                            {t(
                                                'components_project_connection_warehouse_form.snowflake.private_key_file.description.part_3',
                                            )}
                                        </p>
                                    }
                                    required={requireSecrets}
