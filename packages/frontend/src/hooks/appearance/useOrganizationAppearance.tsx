...
export const useCreateColorPalette = () => {
    ...
    >((data) => createColorPaletteApi(data), {
        ...
        onSuccess: async () => {
            ...
            showToastSuccess({
                title: t(
                    'hooks_organization_appearance.color_palette.create.success',
                ),
            });
        },
        onError: ({ error }) => {
            showToastApiError({
                title: t(
                    'hooks_organization_appearance.color_palette.create.error',
                ),
                apiError: error,
            });
        },
...
export const useUpdateColorPalette = () => {
    ...
    >((data) => updateColorPaletteApi(data.uuid, data), {
        ...
        onSuccess: async () => {
            ...
            showToastSuccess({
                title: t(
                    'hooks_organization_appearance.color_palette.update.success',
                ),
            });
        },
        onError: ({ error }) => {
            showToastApiError({
                title: t(
                    'hooks_organization_appearance.color_palette.update.error',
                ),
                apiError: error,
            });
        },
    ...
    return useMutation<null, ApiError, string>(
        (colorPaletteUuid) => deleteColorPaletteApi(colorPaletteUuid),
        {
            ...
            onSuccess: async () => {
                ...
                showToastSuccess({
                    title: t(
                        'hooks_organization_appearance.color_palette.delete.success',
                    ),
                });
            },
            onError: ({ error }, colorPaletteUuid) => {
                showToastApiError({
                    title: t(
                        'hooks_organization_appearance.color_palette.delete.error',
                    ),
                    apiError: error,
                });
            },
    ...
    return useMutation<ApiColorPaletteResponse['results'], ApiError, string>(
        (colorPaletteUuid) => setActiveColorPaletteApi(colorPaletteUuid),
        {
            ...
            onSuccess: async () => {
                ...
                showToastSuccess({
                    title: t(
                        'hooks_organization_appearance.color_palette.set_active.success',
                    ),
                });
            },
            onError: ({ error }) => {
                showToastApiError({
                    title: t(
                        'hooks_organization_appearance.color_palette.set_active.error',
                    ),
                    apiError: error,
                });
            },
