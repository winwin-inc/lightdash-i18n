                ...
                <Popover.Dropdown p={0}>
                    <Stack px="sm" pt="sm" spacing="xs">
                        <TagInput
                            ...
                            placeholder={t(
                                'features_metrics_catalog_components.category_form.search',
                            )}
                            size="xs"
                            mb="xs"
                            radius="md"
                        ...
                        <Text size="xs" fw={500} color="dimmed">
                            {t(
                                'features_metrics_catalog_components.category_form.select_category',
                            )}
                        </Text>
                    </Stack>
                        ...
                        {canCreateTag && (
                            ...
                            >
                                <Group spacing={4}>
                                    <Text>
                                        {t(
                                            'features_metrics_catalog_components.category_form.create',
                                        )}
                                    </Text>
                                    {tagColor && (
                                        <CatalogCategory
