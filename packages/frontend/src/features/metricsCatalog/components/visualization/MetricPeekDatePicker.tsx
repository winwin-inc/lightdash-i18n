                    ...
                    {showTimeDimensionIntervalPicker &&
                        timeDimensionBaseField && (
                            <Tooltip
                                variant="xs"
                                label={t(
                                    'features_metrics_catalog_components.metric_peek_date_picker.change_granularity',
                                )}
                                position="top"
                                withinPortal
                            >
                        ...
                        <Box p="sm">
                            <Group position="apart" spacing="xl">
                                ...
                                <Group spacing="xs">
                                    ...
                                    >
                                        {t(
                                            'features_metrics_catalog_components.metric_peek_date_picker.cancel',
                                        )}
                                    </Button>
                                    <Button
                                        size="xs"
                                    ...
                                    >
                                        {t(
                                            'features_metrics_catalog_components.metric_peek_date_picker.apply',
                                        )}
                                    </Button>
                                </Group>
                            </Group>
