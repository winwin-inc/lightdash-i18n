            ...
            <Stack w="100%" spacing={0}>
                ...
                {healthData?.hasCacheAutocompleResults ? (
                    <Tooltip
                        ...
                        position="left"
                        label={t(
                            'features_metrics_catalog_visualzation.refresh_cache',
                        )}
                    >
                        <Text
                            color="dimmed"
                        ...
                        >
                            {t(
                                'features_metrics_catalog_visualzation.results_loaded',
                            )}{' '}
            ...
            <MultiSelect
                ...
                getCreateLabel={(query) => (
                    <Group spacing="xxs">
                        ...
                        <Text color="blue">
                            {t('features_metrics_catalog_visualzation.add')} "
                            {query}"
                        </Text>
                    </Group>
                )}
                ...
                nothingFound={
                    isInitialLoading
                        ? t('features_metrics_catalog_visualzation.loading')
                        : t(
                              'features_metrics_catalog_visualzation.no_results_found',
                          )
                }
                rightSection={
