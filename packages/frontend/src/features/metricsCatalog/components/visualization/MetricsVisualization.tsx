    ...
    const timeDimensionTooltipLabel = useMemo(() => {
        ...
        if (query.comparison === MetricExplorerComparison.DIFFERENT_METRIC) {
            ...
            return (
                <Text>
                    {t(
                        'features_metrics_catalog_components.metric_visualization.different.part_1',
                    )}{' '}
                    <Text span fw={600}>
                        {metricTimeDimensionFriendlyName}
                    </Text>{' '}
                    {t(
                        'features_metrics_catalog_components.metric_visualization.different.part_2',
                    )}{' '}
                    <Text span fw={600}>
                        {compareMetricTimeDimensionFriendlyName}
                    </Text>
                    {t(
                        'features_metrics_catalog_components.metric_visualization.different.part_3',
                    )}
                </Text>
            );
        }
                ...
                <Group align="center" noWrap spacing="xs">
                    ...
                    >
                        <Text fw={500} c="gray.7" fz={14}>
                            {t(
                                'features_metrics_catalog_components.metric_visualization.date',
                            )}{' '}
                            ({capitalize(timeDimensionBaseField.interval)})
                        </Text>
                    </Tooltip>
                    ...
                    {results?.metric.availableTimeDimensions && (
                        <Tooltip
                            ...
                            label={t(
                                'features_metrics_catalog_components.metric_visualization.available',
                            )}
                            position="right"
                        >
                            <Box>
