            ...
            <Popover width={300} position="bottom-start">
                <Popover.Target>
                    <Tooltip
                        ...
                        variant="xs"
                        label={t(
                            'features_metrics_metrics_table_top_toolbar.filter_metrics',
                        )}
                    >
                        <Button
                            h={32}
                ...
                <Popover.Dropdown p="sm">
                    <Stack spacing={4}>
                        <Text fz="xs" c="dark.3" fw={600}>
                            {t(
                                'features_metrics_metrics_table_top_toolbar.filter_by_categories',
                            )}
                            :
                        </Text>
                        ...
                        {categories?.length === 0 && (
                            <Text fz="xs" fw={500} c="gray.6">
                                {t(
                                    'features_metrics_metrics_table_top_toolbar.no_categories',
                                )}
                            </Text>
                        )}
