...
export const ParameterSelection: FC<ParameterSelectionProps> = ({
    ...
    if (isLoading) {
        return (
            <Text size={size} c="dimmed">
                {t('features_parameters_selection.loading')}
            </Text>
        );
    }
    ...
    if (isError) {
        return (
            <Text size={size} c="dimmed">
                {t('features_parameters_selection.failed_to_load_parameters')}
            </Text>
        );
    }
    ...
    if (parameterKeys.length === 0) {
        return (
            <Text size={size} c="dimmed">
                {t('features_parameters_selection.no_parameters_available')}
            </Text>
        );
    }
