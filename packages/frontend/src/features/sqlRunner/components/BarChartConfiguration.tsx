            ...
            {isSettingsOpen && (
                <Stack spacing="xs" p="xs">
                    <Config>
                        <Config.Label>
                            {t(
                                'features_sql_runner_bar_chart_configuration.select_y_axis',
                            )}
                        </Config.Label>
                        <Select
                    ...
                    <Group mt="xs" spacing="xs" position="right">
                        ...
                        >
                            {t(
                                'features_sql_runner_bar_chart_configuration.confirm',
                            )}
                        </Button>
                    </Group>
                </Stack>
            ...
            {isSettingsOpen && (
                <Stack spacing="xs" p="xs">
                    <Config>
                        <Config.Label>
                            {t(
                                'features_sql_runner_bar_chart_configuration.select_x_axis',
                            )}
                        </Config.Label>
                        <Select
