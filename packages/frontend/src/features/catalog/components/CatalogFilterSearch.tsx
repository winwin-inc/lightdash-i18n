...
export const CatalogFilterSearch: FC<Props> = ({ filter, setFilter }) => {
    ...
    const filterLabels = useMemo(
        () => [
            {
                label: t(
                    'features_catalog_filter_search.labels.all_item_types',
                ),
                type: undefined,
            },
            {
                label: t('features_catalog_filter_search.labels.tables'),
                type: CatalogFilter.Tables,
            },
            {
                label: t('features_catalog_filter_search.labels.metrics'),
                type: CatalogFilter.Metrics,
            },
            {
                label: t('features_catalog_filter_search.labels.dimensions'),
            ...
            <Popover.Dropdown p={0}>
                <Stack spacing="xs">
                    <Text p="xs" pb={0} fw={400} c="gray.6" fz={11}>
                        {t('features_catalog_filter_search.search_by')}:{' '}
                    </Text>
