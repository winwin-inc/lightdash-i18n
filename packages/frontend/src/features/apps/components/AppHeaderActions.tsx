...
type Props = {
    ...
    /** The latest ready version's number + status â€?used by the favorite flow
     ...
     *  button â€?"Continue building" in the viewer. Pass null on surfaces
     ...
     *  capability â€?the modal then falls back to a default-state render. */
...
const AppHeaderActions: FC<Props> = ({
    ...
    // needs `create:DataApp` â€?not manage rights on this app.
    ...
    // on â€?Drive picker credentials must be configured.
