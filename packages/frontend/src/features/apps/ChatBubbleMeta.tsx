...
type VersionInfo = {
    ...
    isActive: boolean;
    /** Click handler â€?pin the preview to this version. Required so a future
...
type Props = {
     ...
     * elsewhere on the bubble â€?not in this meta row.
     */
    version?: VersionInfo;
    /** Extra class for the row â€?used to align the meta with sibling
...
const ChatBubbleMeta: FC<Props> = ({
    ...
    // Only user bubbles split (name left, timestamp right) â€?that pattern
