            ...
            if (isEmpty(currentSearchResults)) {
                return (
                    <Text size="sm" c="dimmed">
                        {t(
                            'compponents_user_access_multi_select.no_users_found',
                        )}
                    </Text>
                );
            }
    ...
    return (
        <MultiSelect
            ...
            label={
                <Group gap="xs">
                    <Text fz="sm" fw={500}>
                        {t('compponents_user_access_multi_select.user_access')}
                    </Text>
                    <Tooltip
                        label={t(
                            'compponents_user_access_multi_select.tooltip',
                        )}
                        withArrow
                        withinPortal
                        multiline
            ...
            description={`${t(
                'compponents_user_access_multi_select.description.part_1',
            )} ${
                isGroupsEnabled
                    ? t(
                          'compponents_user_access_multi_select.description.part_2',
                      )
                    : ''
            }`}
            placeholder={t('compponents_user_access_multi_select.placeholder')}
            data={selectData}
            clearable
            searchable
