            ...
            <Container py="xl">
                <Stack gap="md">
                    ...
                    >
                        <Title order={5}>
                            {t(
                                'pages_ai_agents_edit_page.agent_not_found.title',
                            )}
                        </Title>
                        <Text size="sm" c="dimmed">
                            {t(
                                'pages_ai_agents_edit_page.agent_not_found.description',
                            )}
                        </Text>
                    </Paper>
                </Stack>
                ...
                <Stack gap="lg">
                    <Stack gap="md" align="center">
                        <Group justify="space-between" w="100%">
                            ...
                            {form.isDirty() && (
                                ...
                                >
                                    {t(
                                        'pages_ai_agents_edit_page.save_changes',
                                    )}
                                </Button>
                            )}
                        </Group>
                        ...
                        <Stack gap="xs" align="center">
                            <Title order={4} ta="center" lineClamp={2}>
                                {isCreateMode
                                    ...
                                    : agent?.name ||
                                      t('pages_ai_agents_edit_page.agent')}
                            </Title>
                        </Stack>
                    </Stack>
                    ...
                    <Stack gap="xs">
                        ...
                        {!isCreateMode && (
                            ...
                            >
                                {t('pages_ai_agents_edit_page.evals')}
                            </Button>
                        )}
                        {!isCreateMode && (
                            <Button
