            ...
            <Stack gap="sm">
                ...
                >
                    ...
                    <Stack gap="xs" align="center">
                        <Title order={5}>
                            {t(
                                'pages_ai_agents_evals_setup.no_evaluations_found',
                            )}
                        </Title>
                        <Text size="sm" c="dimmed" ta="center" maw={400}>
                            {t('pages_ai_agents_evals_setup.content')}
                        </Text>
                    </Stack>
                    <Button
                        ...
                        mt="sm"
                    >
                        {t('pages_ai_agents_evals_setup.create_evaluation')}
                    </Button>
                </Paper>
                {evalCreationModal}
            </Stack>
                        ...
                        <Group justify="space-between" align="flex-start">
                            <Stack gap="xs" style={{ flex: 1 }}>
                                ...
                                <Text size="xs" c="dimmed">
                                    {t('pages_ai_agents_evals_setup.created')}{' '}
                                    {new Date(
