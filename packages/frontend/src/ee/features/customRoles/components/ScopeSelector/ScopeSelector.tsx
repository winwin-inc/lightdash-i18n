                ...
                <Group position="apart">
                    ...
                    <Group spacing="xs">
                        <Text size="sm">
                            {isFullySelected
                                ? t(
                                      'features_custom_roles_scope_selector.deselect_all',
                                  )
                                : t(
                                      'features_custom_roles_scope_selector.select_all',
                                  )}
                        </Text>
                        <Checkbox
        ...
        <Stack spacing="0">
            <div className={styles.stickyHeader}>
                <SimpleGrid cols={2}>
                    <Stack spacing="0">
                        <Title order={5}>
                            {t(
                                'features_custom_roles_scope_selector.permissions.label',
                            )}
                        </Title>
                        <Text
                            mb="md"
                        ...
                        >
                            {t(
                                'features_custom_roles_scope_selector.permissions.description',
                            )}
                        </Text>
                    </Stack>
                    <TextInput
                        ...
                        pr="md"
                        placeholder={t(
                            'features_custom_roles_scope_selector.permissions.placeholder',
                        )}
                ...
                <Group position="apart">
                    <Text size="sm" color="dimmed">
                        {t(
                            'features_custom_roles_scope_selector.selected_scopes',
                            {
                                selectedCount,
                                totalScopes,
                            },
                    ...
                    <Group spacing="xs">
                        ...
                        >
                            {t(
                                'features_custom_roles_scope_selector.clear_all',
                            )}
                        </Button>
                        <Button
                            variant="subtle"
            ...
            {filteredScopes.length === 0 ? (
                <Paper p="xl">
                    <Text align="center">
                        {t(
                            'features_custom_roles_scope_selector.no_scopes_found',
                        )}
                    </Text>
                </Paper>
            ) : (
