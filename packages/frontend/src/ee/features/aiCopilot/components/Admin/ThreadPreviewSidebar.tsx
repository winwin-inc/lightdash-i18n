            ...
            <Group justify="space-between" align="flex-start" p="sm">
                <Group gap="xs">
                    <Title order={5} fw={600}>
                        {t(
                            'ai_agent_form_setup_admin.thread_preview_sidebar.thread_preview',
                        )}
                    </Title>
                    <Tooltip
                        label={t(
                            'ai_agent_form_setup_admin.thread_preview_sidebar.open_thread',
                        )}
                        variant="xs"
                        position="right"
                    >
                ...
                <Group gap="xs">
                    <Tooltip
                        label={t(
                            'ai_agent_form_setup_admin.thread_preview_sidebar.open_agent_settings',
                        )}
                        variant="xs"
                        position="right"
                    >
