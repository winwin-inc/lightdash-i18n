                ...
                >
                    <Group gap="xs">
                        <SearchFilter
                            ...
                            setSearch={setSearch}
                            placeholder={t(
                                'ai_agent_form_setup_admin.top_toolbar.search',
                            )}
                        />
                        ...
                        {hasActiveFilters && onClearFilters && (
                            <>
                                ...
                                >
                                    {t(
                                        'ai_agent_form_setup_admin.top_toolbar.clear_all_filters',
                                    )}
                                </Button>
                            </>
                        )}
                    ...
                    <Group gap="xs">
                        ...
                        >
                            <Text fz="sm" fw={500}>
                                {isFetching
                                    ? t(
                                          'ai_agent_form_setup_admin.top_toolbar.loading',
                                      )
                                    : hasNextPage
                                    ? t(
                                          'ai_agent_form_setup_admin.top_toolbar.threads_count',
                                          {
                                    ...
                                    : t(
                                          'ai_agent_form_setup_admin.top_toolbar.threads',
                                          {
                                              total: totalResults,
                                          },
                                      )}
