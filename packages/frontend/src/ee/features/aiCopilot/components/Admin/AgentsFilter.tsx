...
const AgentsFilter: FC<AgentsFilterProps> = ({
    ...
    const buttonLabel = hasSelectedAgents
        ? agentNames
        : t('ai_agent_form_setup_admin.agents_filter.all_agents');
        ...
        <Group gap="two">
                ...
                <Popover.Target>
                    <Tooltip
                        ...
                        label={
                            hasSelectedProjects
                                ? t(
                                      'ai_agent_form_setup_admin.agents_filter.tooltip.part_2',
                                  )
                                : t(
                                      'ai_agent_form_setup_admin.agents_filter.tooltip.part_1',
                                  )
                        }
                    >
                        <Button
                    ...
                    <Stack gap={4}>
                        ...
                        {hasSelectedProjects && (
                            <Text fz="xs" c="blue.6" fw={500}>
                                {t(
                                    'ai_agent_form_setup_admin.agents_filter.showing_agents_from_selected_projects_only',
                                )}
                            </Text>
                        )}
                        ...
                        {organizationAiAgents.data?.length === 0 && (
                            <Text fz="xs" fw={500} c="gray.6">
                                {t(
                                    'ai_agent_form_setup_admin.agents_filter.no_agents_available',
                                )}
                            </Text>
                        )}
            ...
            {hasSelectedAgents && (
                <Tooltip
                    variant="xs"
                    label={t(
                        'ai_agent_form_setup_admin.agents_filter.clear_all_agent_filters',
                    )}
                >
                    <ActionIcon
                        size="xs"
