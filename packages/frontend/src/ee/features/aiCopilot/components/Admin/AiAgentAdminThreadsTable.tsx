...
const AiAgentAdminThreadsTable = ({
    ...
    const columns: MRT_ColumnDef<AiAgentAdminThreadSummary>[] = [
        {
            accessorKey: 'title',
            header: t('ai_agent_form_setup_admin.threads_table.thread'),
            enableSorting: false,
            enableEditing: false,
            size: 300,
            Header: ({ column }) => (
                ...
                return (
                    <Tooltip
                        ...
                        label={
                            thread.title ||
                            t(
                                'ai_agent_form_setup_admin.threads_table.untitled_thread',
                            )
                        }
        ...
        },
        {
            ...
            header: t('ai_agent_form_setup_admin.threads_table.agent'),
            enableSorting: false,
            enableEditing: false,
            size: 170,
            Header: ({ column }) => (
        ...
        },
        {
            ...
            header: t('ai_agent_form_setup_admin.threads_table.project'),
            enableSorting: false,
            enableEditing: false,
            Header: ({ column }) => (
                <Group gap="two">
        ...
        },
        {
            ...
            header: t('ai_agent_form_setup_admin.threads_table.user'),
            enableSorting: false,
            enableEditing: false,
            Header: ({ column }) => (
                <Group gap="two">
        ...
        },
        {
            ...
            header: t('ai_agent_form_setup_admin.threads_table.source'),
            enableSorting: false,
            enableEditing: false,
            size: 120,
            Header: ({ column }) => (
        ...
        },
        {
            ...
            header: t('ai_agent_form_setup_admin.threads_table.prompts'),
            enableSorting: false,
            enableEditing: false,
            size: 125,
            Header: ({ column }) => (
        ...
        },
        {
            ...
            header: t('ai_agent_form_setup_admin.threads_table.feedback'),
            enableSorting: false,
            enableEditing: false,
            size: 140,
            Header: ({ column }) => (
        ...
        },
        {
            ...
            header: t('ai_agent_form_setup_admin.threads_table.created'),
            enableSorting: true,
            enableEditing: false,
            Header: ({ column }) => (
                <Group gap="two">
