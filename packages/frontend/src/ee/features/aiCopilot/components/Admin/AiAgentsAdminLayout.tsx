    ...
    if (!canManageOrganization) {
        return (
            <Box mt="30vh">
                <SuboptimalState
                    title={t(
                        'ai_agent_form_setup_admin.admin_layout.no_access.title',
                    )}
                    description={
                        <>
                            {t(
                                'ai_agent_form_setup_admin.admin_layout.no_access.description',
                            )}
                        </>
                    }
                    icon={IconLock}
        ...
        <Stack h={`calc(100vh - ${NAVBAR_HEIGHT}px)`} style={{ flex: 1 }}>
                ...
                >
                    <Group justify="space-between" my="md">
                        <Box>
                            <Group>
                                <Title order={2}>
                                    {t(
                                        'ai_agent_form_setup_admin.admin_layout.ai_agents_admin_panel',
                                    )}
                                </Title>
                                {activeTab === 'threads' &&
                                    isAnalyticsEmbedEnabled && (
                                        ...
                                        >
                                            {t(
                                                'ai_agent_form_setup_admin.admin_layout.insights',
                                            )}
                                        </Button>
                                    )}
                            </Group>
                            <Text c="gray.6" size="sm" fw={400}>
                                {activeTab === 'threads'
                                    ? t(
                                          'ai_agent_form_setup_admin.admin_layout.view_and_manage_ai_agents_threads',
                                      )
                                    : t(
                                          'ai_agent_form_setup_admin.admin_layout.view_and_manage_ai_agents',
                                      )}
                            </Text>
                        </Box>
                    ...
                    {settings?.aiAgentsVisible === false && (
                        <Paper my="md">
                            <Alert
                                ...
                                bg="orange.0"
                                title={t(
                                    'ai_agent_form_setup_admin.admin_layout.ai_features_disabled.title',
                                )}
                            >
                                <Text c="gray.7" size="xs">
                                    {t(
                                        'ai_agent_form_setup_admin.admin_layout.ai_features_disabled.description',
                                    )}
                                </Text>
                            </Alert>
                        </Paper>
                    ...
                    <Group justify="space-between" my="sm">
                        ...
                        {activeTab === 'threads' && (
                            ...
                            >
                                {t(
                                    'ai_agent_form_setup_admin.admin_layout.new_thread',
                                )}
                            </LinkButton>
                        )}
                        {activeTab === 'agents' && (
                            ...
                            >
                                {t(
                                    'ai_agent_form_setup_admin.admin_layout.new_agent',
                                )}
                            </LinkButton>
                        )}
                    </Group>
            ...
            <Modal
                ...
                title={
                    <Text fw={700}>
                        {t(
                            'ai_agent_form_setup_admin.admin_layout.ai_agents_insights',
                        )}
                    </Text>
                }
                padding="0"
