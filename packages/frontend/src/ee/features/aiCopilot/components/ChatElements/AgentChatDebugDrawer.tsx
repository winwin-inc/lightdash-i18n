...
const AgentChatDebugDrawer: React.FC<Props> = ({
    ...
    return (
        <Drawer
            title={t(
                'ai_agent_form_setup_admin.agent_chat_debug_drawer.debug_information',
            )}
            ...
            <Accordion variant="contained" chevronPosition="right">
                <Accordion.Item value="visualization">
                    ...
                    >
                        <Text fw={500}>
                            {t(
                                'ai_agent_form_setup_admin.agent_chat_debug_drawer.configuration_for',
                            )}
                ...
                <Accordion.Item value="tool-calls">
                    ...
                    >
                        <Text fw={500}>
                            {t(
                                'ai_agent_form_setup_admin.agent_chat_debug_drawer.tool_calls',
                            )}
                        </Text>
                    </Accordion.Control>
                    <Accordion.Panel>
