    ...
    if (!evaluation) {
        return (
            <Stack gap="md">
                ...
                <Text>
                    {t(
                        'ai_copilot_chat_elements_evals_detail.evaluation_not_found',
                    )}
                </Text>
            </Stack>
        );
                                ...
                                <Group justify="space-between" align="center">
                                    <Group align="center" gap="xs">
                                        ...
                                        <Group gap="two">
                                            ...
                                            >
                                                {t(
                                                    'ai_copilot_chat_elements_evals_detail.test_prompts',
                                                )}
                                            </Title>
                                            <Tooltip
                                                label={
                                                    <>
                                                        ...
                                                        <Text fz="xs">
                                                            {t(
                                                                'ai_copilot_chat_elements_evals_detail.created',
                                                            )}{' '}
                                                            {new Date(
                                    ...
                                    >
                                        {t(
                                            'ai_copilot_chat_elements_evals_detail.edit',
                                        )}
                                    </Button>
                                </Group>
                                <ScrollArea.Autosize
                                                ...
                                                <Box style={{ flex: 1 }}>
                                                    ...
                                                    'string' ? (
                                                      ...
                                                      'thread' ? (
                                                        ...
                                                        >
                                                            {t(
                                                                'ai_copilot_chat_elements_evals_detail.invalid_prompt_configuration',
                                                            )}
                                                        </Text>
                                                    )}
                                                </Box>
