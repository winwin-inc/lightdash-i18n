...
const allowedDivStyleProperties: NonNullable<
    sanitize.IOptions['allowedStyles']>[string] = {
    // layout properties
    ...
    // Grid properties
    'grid-template-columns': [/^[a-zA-Z0-9\s\-\.]+$/],
    'grid-template-rows': [/^[a-zA-Z0-9\s\-\.]+$/],
    'grid-column': [/^[a-zA-Z0-9\s\-\.]+$/],
    'grid-row': [/^[a-zA-Z0-9\s\-\.]+$/],
    ...
    // Padding properties
    padding: [/^\d+(?:px|em|rem|%)$/, /^\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)$/, /^\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)$/, /^\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)$/],
    ...
    // Margin properties
    margin: [/^\d+(?:px|em|rem|%)$/, /^auto$/, /^\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)$/, /^\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)$/, /^\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)$/],
    ...
    // Border properties
    border: [/^(?:none|initial|inherit)$/, /^\d+(?:px|em|rem|%)\s+(?:solid|dashed|dotted|double|groove|ridge|inset|outset)\s+[a-zA-Z#0-9]+$/],
    'border-width': [/^\d+(?:px|em|rem|%)$/, /^\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)$/, /^\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)$/, /^\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)$/],
    'border-style': [/^(?:solid|dashed|dotted|double|groove|ridge|inset|outset|none)$/],
    'border-color': colorRegexes,
    'border-radius': [/^\d+(?:px|em|rem|%)$/, /^\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)$/, /^\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)$/, /^\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)\s+\d+(?:px|em|rem|%)$/],
    ...
    'border-right': [/^(?:none|initial|inherit)$/, /^\d+(?:px|em|rem|%)\s+(?:solid|dashed|dotted|double|groove|ridge|inset|outset)\s+[a-zA-Z#0-9]+$/],
    'border-left': [/^(?:none|initial|inherit)$/, /^\d+(?:px|em|rem|%)\s+(?:solid|dashed|dotted|double|groove|ridge|inset|outset)\s+[a-zA-Z#0-9]+$/],
    'border-top': [/^(?:none|initial|inherit)$/, /^\d+(?:px|em|rem|%)\s+(?:solid|dashed|dotted|double|groove|ridge|inset|outset)\s+[a-zA-Z#0-9]+$/],
    'border-bottom': [/^(?:none|initial|inherit)$/, /^\d+(?:px|em|rem|%)\s+(?:solid|dashed|dotted|double|groove|ridge|inset|outset)\s+[a-zA-Z#0-9]+$/],
    
    // Background properties
    'background-color': colorRegexes,
    'background-image': [/^url\(['"]?[^'"]*['"]?\)$/, /^none$/],
    'background-size': [/^(?:cover|contain|auto|initial|inherit)$/, /^\d+(?:px|em|rem|%|auto)(?:\s+\d+(?:px|em|rem|%|auto))?$/],
    'background-position': [/^(?:left|right|top|bottom|center)$/, /^\d+(?:px|em|rem|%)(?:\s+\d+(?:px|em|rem|%))?$/],
    ...
    'transform-origin': [/^(?:left|right|top|bottom|center)$/, /^\d+(?:px|em|rem|%)(?:\s+\d+(?:px|em|rem|%))?$/],
    ...
    opacity: [/^[01]?\.?\d+$/],
    'box-shadow': [/^(?:none|inset\s+)?\d+(?:px|em|rem)\s+\d+(?:px|em|rem)(?:\s+\d+(?:px|em|rem))?(?:\s+[a-zA-Z#0-9]+)?$/],
    'text-shadow': [/^(?:none|\d+(?:px|em|rem)\s+\d+(?:px|em|rem)(?:\s+\d+(?:px|em|rem))?(?:\s+[a-zA-Z#0-9]+)?)$/],
    cursor: [/^(?:auto|default|pointer|text|wait|move|not-allowed|help)$/],
    'user-select': [/^(?:auto|none|text|all)$/],
    'pointer-events': [/^(?:auto|none|all|fill|stroke|visible|visibleFill|visibleStroke|painted|fill|stroke|all)$/],
};
