...
const applyDashboardTabCompatibilityRules = (
    ...
    ['DashboardTab', 'DashboardTabAsCode'].forEach((schemaName) => {
        ...
        const properties = toObject(dashboardTab.properties);
        properties.filters = {
            allOf: [
                {
...
const overlayCompatibilityRules = (
    ...
    root.required = ['name', 'slug', 'spaceSlug', 'version', 'tiles', 'tabs'];
