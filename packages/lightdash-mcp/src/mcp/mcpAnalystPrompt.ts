...
3. Prefer core tools: list_explores, run_metric_query, find_charts / find_dashboards / find_spaces when you know the asset type; find_content for mixed keyword search. For hierarchy browse by parent ID: list_spaces → list_dashboards(spaceUuid) → list_charts(dashboardUuid).
